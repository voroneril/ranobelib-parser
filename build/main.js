...
(async () => {
    ...
    const bookInfo = await index_1.$bookService.getBookInfo(PAGE_URL);
    console.log('\nПолучение списка глав...');
    await index_1.$commonService.delay(1000);
    const chapters = await index_1.$bookService.getChapters(PAGE_URL);
    console.log('\nЗагрузка всех глав книги, поочередно...');
    await index_1.$commonService.delay(1000);
    const bookContent = await index_1.$bookService.getAllBookContent(chapters);
